...
class Profile extends Component {
  ...
  editIntro(values) {
    ...
    axios.post("http://localhost:3001/uploadphotos/setname", data).then(() => {
      axios.post("http://localhost:3001/uploadphotos", formData).then(() => {
  ...
  render() {
    ...
    const closeEditEducation = (
      <button className="close" onClick={this.edit_education_toggle}>
        &times;
      </button>
    );
    const closeEditExperience = (
      <button className="close" onClick={this.edit_experience_toggle}>
        &times;
      </button>
    );
    var image,
      ...
      current_position,
      industry;
    if (this.props.image) image = "data:image/jpg;base64, " + this.props.image;
    if (this.props.firstName) firstName = this.props.firstName;
    else firstName = "";

    if (this.props.lastName) lastName = this.props.lastName;
    else lastName = "";

    if (this.props.headline) headline = this.props.headline;
    else headline = "";
      ...
      education = this.props.education.map(user_education => {
        const EditEducationButton = (
          <button
            ...
            name="edit"
            value={JSON.stringify(user_education)}
            className="btn btn-link float-right"
            onClick={this.edit_education_toggle}
          >
            Edit
          </button>
        );
          ...
          <div>
            <div className="row">
              <div className="col-sm-11">
                <h6>
                  <b>{user_education.school}</b>
                </h6>
                <h6>
                  {user_education.degree}, {user_education.field}
                </h6>
                <h6>
                  {user_education.fromYear} - {user_education.toYear}
                </h6>
              </div>
      ...
      experience = this.props.experience.map(user_experience => {
        const EditExperienceButton = (
          <button
            ...
            name="edit"
            value={JSON.stringify(user_experience)}
            className="btn btn-link float-right"
            onClick={this.edit_experience_toggle}
          >
            Edit
          </button>
        );
        ...
        return (
          <div>
            <div className="row">
              <div className="col-sm-11">
                <h6>
                  <b>{user_experience.title}</b>
                </h6>
                <h6>{user_experience.company}</h6>
                <h6>
                  {user_experience.fromMonth} {user_experience.fromYear} -{" "}
                  {user_experience.toMonth} {user_experience.toYear}
                </h6>
    ...
    if (this.props.contact) contact = this.props.contact;
    else contact = "";
    ...
    if (this.props.industry) industry = this.props.industry;
    else industry = "";
    const closeContact = (
      <button className="close" onClick={this.contact_toggle}>
        &times;
      </button>
    );
    const closeAddEducation = (
      <button className="close" onClick={this.add_education_toggle}>
        &times;
      </button>
    );
    const closeAddExperience = (
      <button className="close" onClick={this.add_experience_toggle}>
        &times;
      </button>
    );
    ...
    const addEducationButton = (
      <button
        className="btn btn-link float-right"
        onClick={this.add_education_toggle}
      >
        +
      </button>
    );
    const addExperienceButton = (
      <button
        className="btn btn-link float-right"
        onClick={this.add_experience_toggle}
      >
        +
      </button>
    );

    const EditIntroButton = (
      <button
        className="btn btn-link float-right"
        onClick={this.edit_intro_toggle}
      >
        Edit
      </button>
    );
    const closeEditIntro = (
      <button className="close" onClick={this.edit_intro_toggle}>
        &times;
      </button>
    );
    ...
    else redirectModal = <Redirect to="/profile" />;
                ...
                <div className="bordered-div">
                  <div className="row">
                    ...
                    <div className="col-sm-4">
                      ...
                      <Modal
                        isOpen={this.props.modal_edit_intro}
                        toggle={this.edit_intro_toggle}
                      >
                        <ModalHeader
                          toggle={this.edit_intro_toggle}
                          close={closeEditIntro}
                        >
                          Edit intro
                        </ModalHeader>
                        <ModalBody>
                          <form
                            name={"edit_intro_form"}
                            enctype="multipart/form-data"
                            onSubmit={handleSubmit(this.editIntro.bind(this))}
                          >
                      ...
                      <input
                        ...
                        onClick={this.contact_toggle}
                        value="See contact info"
                      />
                      {redirectModal}

                      <input
                        className="float-right btn btn-link"
                        /*onClick={this.toggle}*/ value="See connections"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="bordered-div">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-6">
                      ...
                      <Modal
                        isOpen={this.props.modal_add_experience}
                        toggle={this.add_experience_toggle}
                      >
                        <ModalHeader
                          toggle={this.add_experience_toggle}
                          close={closeAddExperience}
                        >
                          Add Experience
                        </ModalHeader>
                        <ModalBody>
                  ...
                  <Modal
                    isOpen={this.props.modal_edit_experience}
                    toggle={this.edit_experience_toggle}
                  >
                    <ModalHeader
                      toggle={this.edit_experience_toggle}
                      close={closeEditExperience}
                    >
                      Edit experience
                    </ModalHeader>
                    <ModalBody>
                      <form
                        id={this.props.edit_exp_id}
                        name={"edit_experience_form"}
                        onSubmit={this.editExperience.bind(this)}
                      >
                        Title
                        <Field
                ...
                <div className="bordered-div">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-6">
                      ...
                      <Modal
                        isOpen={this.props.modal_add_education}
                        toggle={this.add_education_toggle}
                      >
                        <ModalHeader
                          toggle={this.add_education_toggle}
                          close={closeAddEducation}
                        >
                          Add Education
                        </ModalHeader>
                        <ModalBody>
                          <form
                            name={"add_education_form"}
                            onSubmit={handleSubmit(
                  ...
                  <Modal
                    isOpen={this.props.modal_edit_education}
                    toggle={this.edit_education_toggle}
                  >
                    <ModalHeader
                      toggle={this.edit_education_toggle}
                    ...
                    <ModalBody>
                      <form
                        id={this.props.edit_edu_id}
                        name={"edit_education_form"}
                        onSubmit={this.editEducation.bind(this)}
                      >
                        School
                        <Field
...
const mapDispatchStateToProps = dispatch => {
  return {
    getprofile: username => {
      ...
      axios
        .get(BACKEND_HOST + "/profile/" + username, {
          headers: {
    ...
    addEducation: values => {
      axios.post(BACKEND_HOST + "/profile/education", values).then(response => {
        console.log("Dispacting ADDEDUCATION");
        dispatch({ type: "ADDEDUCATION", payload: response.data });
      });
      axios
        .get(BACKEND_HOST + "/profile/education/" + values.username, {
          headers: {
            authorization: "jwt" + sessionStorage.getItem("usertoken")
          }
        })
    ...
    addExperience: values => {
      axios
        .post(BACKEND_HOST + "/profile/experience", values)
        .then(response => {
          dispatch({ type: "ADDEXPERIENCE", payload: response.data });
        });
      axios
        .get(BACKEND_HOST + "/profile/experience/" + values.username, {
          headers: {
            authorization: "jwt" + sessionStorage.getItem("usertoken")
          }
        })
    ...
    editEducation: values => {
      axios.put(BACKEND_HOST + "/profile/education", values).then(response => {
        dispatch({
          type: "EDITEDUCATION",
          payload: response.data
        });
    ...
    editEducationID: value => {
      dispatch({
        type: "EDITEDUCATION_ID",
        payload: value
      });
    },
    editEduValues: values => {
      dispatch({
        type: "EDITEDUCATION_VALUES",
        payload: values
      });
    },

    editExperience: values => {
      axios.put(BACKEND_HOST + "/profile/experience", values).then(response => {
        dispatch({
          type: "EDITEXPERIENCE",
          payload: response.data
        });
    ...
    deleteEducation: value => {
      axios
        .delete(BACKEND_HOST + "/profile/education", { data: value })
        .then(response => {
          dispatch({
      ...
      axios
        .get(BACKEND_HOST + "/profile/education/" + value.username, {
          headers: {
            authorization: "jwt" + sessionStorage.getItem("usertoken")
          }
        })
    ...
    deleteExperience: value => {
      console.log(value);
      axios
        .delete(BACKEND_HOST + "/profile/experience", { data: value })
        .then(response => {
          dispatch({
            type: "DELETE_EDUCATION",
            payload: response.data
      ...
      axios
        .get(BACKEND_HOST + "/profile/experience/" + value.username, {
          headers: {
            authorization: "jwt" + sessionStorage.getItem("usertoken")
          }
        })
    ...
    editIntro: values => {
      ...
      axios.put(BACKEND_HOST + "/profile/intro", values).then(response => {
