  ...
  handlelogout() {
    this.props.logout(res => {
      if (res.status === "SUCCESS") {
        ...
        document
          .getElementById("success_snackbar")
    ...
    return (
      <div>
          ...
          <div className="container">
            <div className="d-flex w-100">
              ...
              <div
                ...
                style={{ display: this.state.isLoggedIn ? "none" : "flex" }}
              >
                <img
                  alt="LinkedIn"
              ...
              <form
                className="navbar-form navbar-right ml-auto form-inline"
                style={{ display: this.state.isLoggedIn ? "none" : "flex" }}
              ...
              <div
                className="align-self-center align-items-end ml-auto"
                style={{ display: this.state.isLoggedIn ? "flex" : "none" }}
              >
                <ul
                ...
                >
                  ...
                  <li className="nav-item nav-link mx-4 py-0 dropdown">
                    ...
                    >
                      <div className="dropdown-item">
                        ...
                        <br />
                        <Link to="/profile">
                          <span className="text-info">View Profile</span>
                        </Link>
                      </div>
                  ...
                  <li
                    className="nav-item nav-link py-0 mx-4"
                    style={{
                      display:
                        this.props.user_type === "recruiter" ? "flex" : "none"
                    }}
                  >
                    <Link to="/jobpost">
                      <span className="icon-text">
        ...
        <div id="d-flex-inline mx-auto">
          <div
            id="alert_snackbar"
            className="alert alert-danger snackbar"
            role="alert"
            style={{ display: "none" }}
          >
            <p id="alert_text" />
          ...
          <div
            id="success_snackbar"
            className="alert alert-success snackbar"
            role="alert"
            style={{ display: "none" }}
          >
            <p id="success_text" />
